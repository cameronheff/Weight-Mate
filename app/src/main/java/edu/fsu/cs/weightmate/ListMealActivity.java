    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      Cursor cursor2 = getContentResolver().query(
       ...
       remainingCarbsView.setText(String.valueOf(carbsRemaining));
        ...
        //Loop through the database and add meals from today
        cursor.moveToFirst();
        ...
        if(cursor == null){
            ...
            if(cursor.moveToFirst()) {
                while (cursor.moveToNext()) {
                    ...
                    Log.d("dbd", cursor.getString(2));
                    Log.d("dbd", cursor.getString(3));
                    Log.d("dbd", Double.toString(cursor.getDouble(4)));
                    Log.d("dbd", Double.toString(cursor.getDouble(5)));
                    Log.d("dbd", Double.toString(cursor.getDouble(6)));

                    //Create string
                    String s = "";
                    s = s + "Meal: " + cursor.getString(2) + "\n";
                    s = s + "Calories: " + Double.toString(cursor.getDouble(3)) + "\n";
                    s = s + "Protein: " + Double.toString(cursor.getDouble(4)) + "\n";
                    s = s + "Carbs: " + Double.toString(cursor.getDouble(5)) + "\n";
                    s = s + "Fat: " + Double.toString(cursor.getDouble(6)) + "\n";
                    s = s + "Date: " + cursor.getString(1) + "\n";
